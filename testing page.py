...
VALID_ROOMS = {
    ...
    "RM201": {
        "building": "Ramon Magsaysay Building (2nd Floor)",
        "coords": (16.937715315657673, 121.76392437370077)
    },
    "IT101": {
    ...
    "IT201": {
        "building": "CCSICT Building (3rd Floor)",
        "coords": (16.938197528772875, 121.764063538908)
    },
    "NB101": {
        "building": "CBM Building (1st Floor",
    ...
    "UBA": {
        "building": "CED Building (1st Floor)",
    ...
    "OB101": {
        "building": "CED Building (1st Floor)",
        "coords": (16.936615869622035, 121.76468429828296)
    },
    "OB201": {
        "building": "CED Building (1st Floor)",
        "coords": (16.936615869622035, 121.76468429828296)
    ...
    "SAS101": {
        "building": "SAS Building (1st Floor)",
...
class MapScreen(Screen):
    ...
    def show_markers_for_day(self, day):
        ...
        for entry in schedule_screen.table.row_data:
            ...
            if sched_day == day and room in VALID_ROOMS:
                lat, lon = VALID_ROOMS[room]["coords"]
